...
4. `/etc/os-release` पढेर OS जानकारी जाँच्ने
5. `uname` प्रयोग गरेर kernel जानकारी जाँच्ने
6. AlmaLinux र Ubuntu बीचको फरक सोच्ने
7. जाँचिएको जानकारी आफ्नै शब्दमा व्याख्या गर्ने
...
## 6. `/etc/os-release` र `uname` बीचको फरक
...
## 7. AlmaLinux र Ubuntu बीचको फरक सोच्ने
