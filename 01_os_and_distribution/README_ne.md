...
```mermaid
flowchart TD
	A["1. OS भनेको के हो भनेर बुझ्ने"] --> B["2. Linux kernel भनेको के हो भनेर बुझ्ने"]
	B --> C["3. Distribution भनेको के हो भनेर बुझ्ने"]
	C --> D["4. Shell भनेको के हो भनेर बुझ्ने"]
	D --> E["5. /etc/os-release पढेर OS जानकारी जाँच्ने"]
	E --> F["6. uname प्रयोग गरेर kernel जानकारी जाँच्ने"]
	F --> G["7. /etc/os-release र uname बीचको फरक बुझ्ने"]
	G --> H["8. AlmaLinux र Ubuntu बीचको फरक सोच्ने"]
	H --> I["9. जाँच command चलाएर वातावरण जानकारी मिलाउने"]
	I --> J["10. जाँचिएको जानकारी आफ्नै शब्दमा व्याख्या गर्ने"]
```
